...
<div style="margin-top: 120px; margin-bottom: 60px; background: white;" class="container">
    <table style="text-align: center" id="product" class="table table-striped">
        ...
        <c:forEach var="product" items="${listProduct}">
            <tr>
                ...
                <td><a href="${product.image}" style="display: block; background-image: url(${product.image}); width: 60px; height: 60px; background-size: cover"></a></td>
                <td>
                    <a href="?action=update-product&id=${product.id}" type="button" class="btn btn-warning">
                        Update
                    </a>
                </td>
                <td>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="?action=delete-product" method="post">
