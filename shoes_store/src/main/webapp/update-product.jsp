...
<div style="max-width: 600px" class="container">
    ...
    <form action="?action=update-product&id=${product.id}" method="post">
        <div class="form-group">
            <label for="nameProduct">Name product:</label>
            <input type="text" class="form-control" value="${product.name}" id="nameProduct" name="nameProduct">
        </div>
        <div class="form-group">
            <label for="oldPrice">Old price:</label>
            <input type="text" class="form-control" value="${product.oldPrice}" id="oldPrice" name="oldPrice">
        </div>
        <div class="form-group">
            <label for="currentPrice">Current price:</label>
            <input type="text" class="form-control" value="${product.currentPrice}" id="currentPrice" name="currentPrice">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea name="imageProduct" id="imageProduct" class="form-control" cols="30" rows="3">${product.image}</textarea>
        </div>
        <div class="form-group">
